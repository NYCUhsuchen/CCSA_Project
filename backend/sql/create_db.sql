...
-- 插入初始數據
INSERT INTO users (name, email, password_hash, role) VALUES ('admin', 'admin@example.com', 'adminpassword', 'teacher');
INSERT INTO users (name, email, password_hash, role) VALUES ('user', 'user@example.com', 'userpassword', 'student');
